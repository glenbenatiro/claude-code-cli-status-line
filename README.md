...
| `cache` | `cache warm · 93% hit · 58m 00s` | `prompt_cache.*` | `warm` or `cold`, hit rate, and time until the cache expires. When cold it ends with `recache 612k`, the tokens a cold cache would have to rewrite. |
